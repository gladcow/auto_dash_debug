...
def get_special_type_obj(obj_str, obj_type):
    ...
    # if privatesend.CDarksendQueueObj.is_this_type(obj_type):
    #     return privatesend.CDarksendQueueObj(obj_str, obj_type)
    # if privatesend.CDarkSendEntryObj.is_this_type(obj_type):
    #     return privatesend.CDarkSendEntryObj(obj_str, obj_type)
    return False
